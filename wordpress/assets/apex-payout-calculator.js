// APEX Whitetail Payout Calculator
// Generated from payoutConfig.js + whitetailCalcV4.js. Element ids are
// namespaced apex-* and the whole thing runs in a closure, so it cannot
// collide with the theme or any plugin.
(function () {
'use strict';
// ---------------------------------------------------------------------------
...
const summaryEntries = document.querySelector('#apex-payout-nums tr td:nth-child(1)');
const summaryModel = document.querySelector('#apex-payout-nums tr td:nth-child(2)');
const summaryRevenue = document.querySelector('#apex-payout-nums tr:nth-child(4) td:nth-child(1)');
const summaryPayout = document.querySelector('#apex-payout-nums tr:nth-child(4) td:nth-child(2)');
const summaryMargin = document.getElementById('apex-gross-margin');

const topTenBody = document.querySelector('#apex-top-ten tbody');
const outsideBody = document.querySelector('#apex-outside-top-ten tbody');
const specialBody = document.querySelector('#apex-special-harvest tbody');

const entriesForm = document.getElementById('apex-hunter-entries');
const entryFeeForm = document.getElementById('apex-entry-fee');
const entriesInput = document.getElementById('apex-hunter-entries-input');
const entryFeeInput = document.getElementById('apex-entry-fee-input');
const inputError = document.getElementById('apex-input-error');
